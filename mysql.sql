...
CREATE TABLE IF NOT EXISTS `morality` (
    ...
    `jlf` int(2) NOT NULL,
    `kf` int(2) NOT NULL,
    `jkfjl1` varchar(200) DEFAULT NULL,
    `jkfjl2` varchar(200) DEFAULT NULL,
    `jkfjl3` varchar(200) DEFAULT NULL,
    `jkfjl4` varchar(200) DEFAULT NULL,
    `jkfjl5` varchar(200) DEFAULT NULL,
    `jkfjl6` varchar(200) DEFAULT NULL,
    `jkfjl7` varchar(200) DEFAULT NULL,
    `jkfjl8` varchar(200) DEFAULT NULL,
    `jkfjl9` varchar(200) DEFAULT NULL,
    `jkfjl10` varchar(200) DEFAULT NULL,
    `jkfjl11` varchar(200) DEFAULT NULL,
    `jkfjl12` varchar(200) DEFAULT NULL,
    `jkfjl13` varchar(200) DEFAULT NULL,
    `jkfjl14` varchar(200) DEFAULT NULL,
    `jkfjl15` varchar(200) DEFAULT NULL,
    `jkfjl16` varchar(200) DEFAULT NULL,
    `jkfjl17` varchar(200) DEFAULT NULL,
    `jkfjl18` varchar(200) DEFAULT NULL,
    `jkfjl19` varchar(200) DEFAULT NULL,
    `jkfjl20` varchar(200) DEFAULT NULL,
    `bz` varchar(60) NOT NULL,
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
